...
angular.module("angularjstexteditor.DOM",["angularjstexteditor.factories"]).factory("taExecCommand",["taSelection","taBrowserTag","$document",function(M,H,w){function b(e,t){for(var n,r=e.find("li"),a=r.length-1;0<=a;a--)n=angular.element("<"+t+">"+r[a].innerHTML+"</"+t+">"),e.after(n);e.remove(),M.setSelectionToElementEnd(n[0])}function y(e,t,n,r,a){for(var o,l,i,s=e.find("li"),d=0;d<s.length;d++)if(s[d].outerHTML===t[0].outerHTML){0<(i=d)&&(o=s[d-1]),d+1<s.length&&(l=s[d+1]);break}var f="";if(r?f+="<"+a+">"+t[0].innerHTML+"</"+a+">":(f+="<"+H(n)+">",f+="<li>"+t[0].innerHTML+"</li>",f+="</"+H(n)+">"),n=angular.element(f),o)if(l){e.parent();var c="",f=e[0].nodeName.toLowerCase();for(c+="<"+f+">",d=0;d<i;d++)c+="<li>"+s[d].innerHTML+"</li>";c+="</"+f+">";var g="";for(g+="<"+f+">",d=i+1;d<s.length;d++)g+="<li>"+s[d].innerHTML+"</li>";g+="</"+f+">",e.after(angular.element(g)),e.after(n),e.after(angular.element(c)),e.remove(),M.setSelectionToElementEnd(n[0])}else t.remove(),e.after(n),M.setSelectionToElementEnd(n[0]);else t.remove(),e.after(angular.element(e[0].outerHTML)),e.after(n),e.remove(),M.setSelectionToElementEnd(n[0])}function o(e){/(<br(|\/)>)$/i.test(e.innerHTML.trim())?M.setSelectionBeforeElement(angular.element(e).find("br")[0]):M.setSelectionToElementEnd(e)}function O(e,t){t=angular.element("<"+t+">"+e[0].innerHTML+"</"+t+">"),e.after(t),e.remove(),o(t.find("li")[0])}function A(e,t,n){for(var r="",a=0;a<e.length;a++)r+="<"+H("li")+">"+e[a].innerHTML+"</"+H("li")+">";n=angular.element("<"+n+">"+r+"</"+n+">"),t.after(n),t.remove(),o(n.find("li")[0])}function x(e,t){for(var n=0;n<e.childNodes.length;n++){var r=e.childNodes[n];r.tagName&&r.tagName.match(BLOCKELEMENTS)&&x(r,t)}if(null===e.parentNode)return e;if("<br>"===t)return e;var a=angular.element(t);return a[0].innerHTML=e.innerHTML,e.parentNode.insertBefore(a[0],e),e.parentNode.removeChild(e),a}return function(T,S){return T=H(T),function(e,t,n,r){var a,o,l,i=angular.element("<"+T+">");try{M.getSelection&&(s=M.getSelection()),void 0!==(o=M.getSelectionElement()).tagName&&("div"===o.tagName.toLowerCase()&&/taTextElement.+/.test(o.id)&&s&&s.start&&1===s.start.offset&&1===s.end.offset||"span"===o.tagName.toLowerCase()&&s&&s.start&&1===s.start.offset&&1===s.end.offset?(c=o.innerHTML,/<br>/i.test(c)&&(c=c.replace(/<br>/i,"&#8203;")),/<br\/>/i.test(c)&&(c=c.replace(/<br\/>/i,"&#8203;")),/<span>(<span>)+/i.test(c)&&(c=__.replace(/<span>(<span>)+/i,"<span>")),/<\/span>(<\/span>)+/i.test(c)&&(c=__.replace(/<\/span>(<\/span>)+/i,"</span>")),l="<div>"+(c=/<span><\/span>/i.test(c)?c.replace(/<span><\/span>/i,""):c)+"</div>",o.innerHTML=l,M.setSelectionToElementEnd(o.childNodes[0]),o=M.getSelectionElement()):"p"===o.tagName.toLowerCase()&&s&&s.start&&1===s.start.offset&&1===s.end.offset?(c=o.innerHTML,/<br>/i.test(c)&&(c=c.replace(/<br>/i,"&#8203;"),o.innerHTML=c)):"li"===o.tagName.toLowerCase()&&s&&s.start&&s.start.offset===s.end.offset&&(c=o.innerHTML,/<br>/i.test(c)&&(c=c.replace(/<br>/i,""),o.innerHTML=c)))}catch(e){}if(o){var s=angular.element(o),d=o&&o.tagName&&o.tagName.toLowerCase()||"";if("insertorderedlist"===e.toLowerCase()||"insertunorderedlist"===e.toLowerCase()){var f=H("insertorderedlist"===e.toLowerCase()?"ol":"ul"),c=M.getOnlySelectedElements();if(1<c.length&&("ol"===d||"ul"===d))return function(e,t,n,r,a){for(var o,l,i=e.find("li"),s=[],d=0;d<i.length;d++)for(o=0;o<t.length;o++)i[d].isEqualNode(t[o])&&(s[o]=d);0<s[0]&&(l=i[s[0]-1]),s[t.length-1]+1<i.length&&(g=i[s[t.length-1]+1]);var f="";if(r)for(o=0;o<t.length;o++)f+="<"+a+">"+t[o].innerHTML+"</"+a+">",t[o].remove();else{for(f+="<"+H(n)+">",o=0;o<t.length;o++)f+=t[o].outerHTML,t[o].remove();f+="</"+H(n)+">"}if(n=angular.element(f),l)if(g){var c="",g=e[0].nodeName.toLowerCase();for(c+="<"+g+">",d=0;d<s[0];d++)c+="<li>"+i[d].innerHTML+"</li>";c+="</"+g+">";var u="";for(u+="<"+g+">",d=s[t.length-1]+1;d<i.length;d++)u+="<li>"+i[d].innerHTML+"</li>";u+="</"+g+">",e.after(angular.element(u)),e.after(n),e.after(angular.element(c)),e.remove(),M.setSelectionToElementEnd(n[0])}else e.after(n),M.setSelectionToElementEnd(n[0]);else e.after(angular.element(e[0].outerHTML)),e.after(n),e.remove(),M.setSelectionToElementEnd(n[0])}(s,c,f,f===d,T);if(d===f)return s[0].childNodes.length!==c.length&&1===c.length?(s=angular.element(c[0]),y(s.parent(),s,f,!0,T)):b(s,T);if("li"===d&&s.parent()[0].tagName.toLowerCase()===f&&1===s.parent().children().length)return b(s.parent(),T);if("li"===d&&s.parent()[0].tagName.toLowerCase()!==f&&1===s.parent().children().length)return O(s.parent(),f);if(d.match(BLOCKELEMENTS)&&!s.hasClass("ta-bind")){if(c.length&&s[0].childNodes.length!==c.length&&1===c.length)return s=angular.element(c[0]),y(s.parent(),s,f,f===d,T);if("ol"===d||"ul"===d)return O(s,f);var g=!1;return angular.forEach(s.children(),function(e){e.tagName.match(BLOCKELEMENTS)&&(g=!0)}),A(g?s.children():[angular.element("<div>"+o.innerHTML+"</div>")[0]],s,f)}if(d.match(BLOCKELEMENTS)){if(0===(p=M.getOnlySelectedElements()).length)a=angular.element("<"+f+"><li>"+o.innerHTML+"</li></"+f+">"),s.html(""),s.append(a);else{if(1===p.length&&("ol"===p[0].tagName.toLowerCase()||"ul"===p[0].tagName.toLowerCase()))return p[0].tagName.toLowerCase()===f?b(angular.element(p[0]),T):O(angular.element(p[0]),f);for(var u,m="",h=[],N=0;N<p.length;N++)3!==p[N].nodeType&&(u=angular.element(p[N]),"li"!==p[N].tagName.toLowerCase()&&("ol"===p[N].tagName.toLowerCase()||"ul"===p[N].tagName.toLowerCase()?m+=u[0].innerHTML:"span"!==p[N].tagName.toLowerCase()||"ol"!==p[N].childNodes[0].tagName.toLowerCase()&&"ul"!==p[N].childNodes[0].tagName.toLowerCase()?m+="<"+H("li")+">"+u[0].innerHTML+"</"+H("li")+">":m+=u[0].childNodes[0].innerHTML,h.unshift(u)));a=angular.element("<"+f+">"+m+"</"+f+">"),h.pop().replaceWith(a),angular.forEach(h,function(e){e.remove()})}return void M.setSelectionToElementEnd(a[0])}}else{if("formatblock"===e.toLowerCase()){for("default"===(f=n.toLowerCase().replace(/[<>]/gi,"")).trim()&&(n="<"+(f=T)+">"),a="li"===d?s.parent():s;!a[0].tagName||!a[0].tagName.match(BLOCKELEMENTS)&&!a.parent().attr("contenteditable");)d=((a=a.parent())[0].tagName||"").toLowerCase();if(d===f){var p=a.children(),L=!1;for(N=0;N<p.length;N++)L=L||p[N].tagName.match(BLOCKELEMENTS);a=L?(a.after(p),s=a.next(),a.remove(),s):(i.append(a[0].childNodes),a.after(i),a.remove(),i)}else if(a.parent()[0].tagName.toLowerCase()!==f||a.parent().hasClass("ta-bind"))if(d.match(LISTELEMENTS))a.wrap(n);else{for(0===(p=M.getOnlySelectedElements()).length&&(p=[a[0]]),N=0;N<p.length;N++)if(3===p[N].nodeType||!p[N].tagName.match(BLOCKELEMENTS))for(;3===p[N].nodeType||!p[N].tagName||!p[N].tagName.match(BLOCKELEMENTS);)p[N]=p[N].parentNode;if(1<(p=p.filter(function(e,t,n){return n.indexOf(e)===t})).length&&(p=p.filter(function(e,t,n){return!("div"===e.nodeName.toLowerCase()&&/^taTextElement/.test(e.id))})),angular.element(p[0]).hasClass("ta-bind"))(a=angular.element(n))[0].innerHTML=p[0].innerHTML,p[0].innerHTML=a[0].outerHTML;else if("blockquote"===f){for(m="",N=0;N<p.length;N++)m+=p[N].outerHTML;for((a=angular.element(n))[0].innerHTML=m,p[0].parentNode.insertBefore(a[0],p[0]),N=p.length-1;0<=N;N--)p[N].parentNode&&p[N].parentNode.removeChild(p[N])}else if("pre"===f&&M.getStateShiftKey()){for(m="",N=0;N<p.length;N++)m+=p[N].outerHTML;for((a=angular.element(n))[0].innerHTML=m,p[0].parentNode.insertBefore(a[0],p[0]),N=p.length-1;0<=N;N--)p[N].parentNode&&p[N].parentNode.removeChild(p[N])}else for(N=0;N<p.length;N++){var E=x(p[N],n);p[N]===a[0]&&(a=angular.element(E))}}else{var v=a.parent(),C=v.contents();for(N=0;N<C.length;N++)v.parent().hasClass("ta-bind")&&3===C[N].nodeType&&((i=angular.element("<"+T+">"))[0].innerHTML=C[N].outerHTML,C[N]=i[0]),v.parent()[0].insertBefore(C[N],v[0]);v.remove()}return M.setSelectionToElementEnd(a[0]),void a[0].focus()}if("createlink"===e.toLowerCase()){if("a"===d)return void(M.getSelectionElement().href=n);var r='<a href="'+n+'" target="'+(r.a.target||"")+'">';return void(M.getSelection().collapsed?M.insertHtml(r+n+"</a>",S):rangy.getSelection().getRangeAt(0).canSurroundContents()&&(r=angular.element(r+"</a>")[0],rangy.getSelection().getRangeAt(0).surroundContents(r)))}if("inserthtml"===e.toLowerCase())return void M.insertHtml(n,S)}try{w[0].execCommand(e,t,n)}catch(e){}}}}}]).service("taSelection",["$document","taDOM","$log","$rangy",function(e,p,t,n){const L=n.rangy;function r(e,t){return e.tagName&&e.tagName.match(/^br$/i)&&0===t&&!e.previousSibling?{element:e.parentNode,offset:0}:{element:e,offset:t}}var a,E=e[0],v={getSelection:function(){try{t=L.getSelection().getRangeAt(0)}catch(e){return}var e=t.commonAncestorContainer,t={start:r(t.startContainer,t.startOffset),end:r(t.endContainer,t.endOffset),collapsed:t.collapsed};return 3===e.nodeType&&("div"===e.parentNode.nodeName.toLowerCase()&&/^taTextElement/.test(e.parentNode.id)||(e=e.parentNode)),"div"===e.nodeName.toLowerCase()&&/^taTextElement/.test(e.id)?(t.start.element=e.childNodes[t.start.offset],t.end.element=e.childNodes[t.end.offset],t.container=e):e.parentNode===t.start.element||e.parentNode===t.end.element?t.container=e.parentNode:t.container=e,t},updateLeftArrowKey:function(e){var t=L.getSelection().getRangeAt(0);if(t&&t.collapsed){var n=v.getFlattenedDom(t);if(!n.findIndex)return;var r,a,o=t.startContainer,l=n.findIndex(function(e,t){return e.node===o||-1!==e.parents.indexOf(o)});if(n.forEach(function(e,t){e.parents.forEach(function(e,t){})}),(r=l+1<n.length?n[l+1].node:r)&&r.textContent&&/^\ufeff([^\ufeff]*)$/.exec(r.textContent))return;if(0<l&&(a=n[l-1].node),0===t.startOffset&&a&&/^\ufeff([^\ufeff]*)$/.exec(a.textContent))return void v.setSelectionToElementEnd(a)}},updateRightArrowKey:function(e){},getFlattenedDom:function(e){var t=e.commonAncestorContainer.parentNode;if(!t)return e.commonAncestorContainer.childNodes;var a=Array.prototype.slice.call(t.childNodes),e=a.indexOf(e.startContainer);return e+1<a.length&&0<e||t.parentNode&&(t=t.parentNode),a=[],function n(r){r.node.childNodes.length?Array.prototype.slice.call(r.node.childNodes).forEach(function(e){var t=r.parents.slice();t.slice(-1)[0]!==r.node&&t.push(r.node),n({parents:t,node:e})}):a.push({parents:r.parents,node:r.node})}({parents:[t],node:t}),a},getOnlySelectedElements:function(){var e=L.getSelection().getRangeAt(0),t=3===(t=e.commonAncestorContainer).nodeType?t.parentNode:t;return e.getNodes([1],function(e){return e.parentNode===t})},getAllSelectedElements:function(){var e=L.getSelection().getRangeAt(0),t=3===(t=e.commonAncestorContainer).nodeType?t.parentNode:t,n=e.getNodes([1],function(e){return e.parentNode===t});if(t.innerHTML.replace(/<span id=.selectionBoundary[^>]+>\ufeff?<\/span>/gi,"")===e.toHtml()&&("div"!==t.nodeName.toLowerCase()||!/^taTextElement/.test(t.id))){for(var r=[],a=n.length;a--;r.unshift(n[a]));(n=r).push(t)}return n},getSelectionElement:function(){if(v.getSelection())return v.getSelection().container},setSelection:function(e,t,n,r){var a=L.createRange();a.setStart(e,n),a.setEnd(t,r),L.getSelection().setSingleRange(a)},setSelectionBeforeElement:function(e){var t=L.createRange();t.selectNode(e),t.collapse(!0),L.getSelection().setSingleRange(t)},setSelectionAfterElement:function(e){var t=L.createRange();t.selectNode(e),t.collapse(!1),L.getSelection().setSingleRange(t)},setSelectionToElementStart:function(e){var t=L.createRange();t.selectNodeContents(e),t.collapse(!0),L.getSelection().setSingleRange(t)},setSelectionToElementEnd:function(e){var t=L.createRange();t.selectNodeContents(e),t.collapse(!1),e.childNodes&&e.childNodes[e.childNodes.length-1]&&"br"===e.childNodes[e.childNodes.length-1].nodeName&&(t.startOffset=t.endOffset=t.startOffset-1),L.getSelection().setSingleRange(t)},setStateShiftKey:function(e){a=e},getStateShiftKey:function(){return a},insertHtml:function(e,t){var n,r,a,o,l,i=angular.element("<div>"+e+"</div>"),s=L.getSelection().getRangeAt(0),d=E.createDocumentFragment(),f=i[0].childNodes,c=!0;if(0<f.length){for(r=[],n=0;n<f.length;n++){var g=f[n];"p"===g.nodeName.toLowerCase()&&""===g.innerHTML.trim()||(c=c&&!BLOCKELEMENTS.test(g.nodeName),r.push(g))}for(var u=0;u<r.length;u++)o=d.appendChild(r[u]);!c&&s.collapsed&&/^(|<br(|\/)>)$/i.test(s.startContainer.innerHTML)&&s.selectNode(s.startContainer)}else c=!0,o=d=E.createTextNode(e);if(c)s.deleteContents();else if(s.collapsed&&s.startContainer!==t)if(s.startContainer.innerHTML&&s.startContainer.innerHTML.match(/^<[^>]*>$/i))m=s.startContainer,1===s.startOffset?(s.setStartAfter(m),s.setEndAfter(m)):(s.setStartBefore(m),s.setEndBefore(m));else{if(3===s.startContainer.nodeType&&s.startContainer.parentNode!==t)for(N=(m=s.startContainer.parentNode).cloneNode(),p.splitNodes(m.childNodes,m,N,s.startContainer,s.startOffset);!VALIDELEMENTS.test(m.nodeName);){angular.element(m).after(N);var m,h=N,N=(m=m.parentNode).cloneNode();p.splitNodes(m.childNodes,m,N,h)}else N=(m=s.startContainer).cloneNode(),p.splitNodes(m.childNodes,m,N,void 0,void 0,s.startOffset);if(angular.element(m).after(N),s.setStartAfter(m),s.setEndAfter(m),/^(|<br(|\/)>)$/i.test(m.innerHTML.trim())&&(s.setStartBefore(m),s.setEndBefore(m),angular.element(m).remove()),/^(|<br(|\/)>)$/i.test(N.innerHTML.trim())&&angular.element(N).remove(),"li"===m.nodeName.toLowerCase()){for(l=E.createDocumentFragment(),a=0;a<d.childNodes.length;a++)i=angular.element("<li>"),p.transferChildNodes(d.childNodes[a],i[0]),p.transferNodeAttributes(d.childNodes[a],i[0]),l.appendChild(i[0]);d=l,o=o&&(o=d.childNodes[d.childNodes.length-1]).childNodes[o.childNodes.length-1]}}else s.deleteContents();s.insertNode(d),o&&v.setSelectionToElementEnd(o)}};return v}]).service("taDOM",function(){var d={getByAttribute:function(e,t){var n=[],r=e.children();return r.length&&angular.forEach(r,function(e){n=n.concat(d.getByAttribute(angular.element(e),t))}),void 0!==e.attr(t)&&n.push(e),n},transferChildNodes:function(e,t){for(t.innerHTML="";0<e.childNodes.length;)t.appendChild(e.childNodes[0]);return t},splitNodes:function(e,t,n,r,a,o){if(!r&&isNaN(o))throw new Error("taDOM.splitNodes requires a splitNode or splitIndex");for(var l=document.createDocumentFragment(),i=document.createDocumentFragment(),s=0;0<e.length&&(isNaN(o)||o!==s)&&e[0]!==r;)l.appendChild(e[0]),s++;for(!isNaN(a)&&0<=a&&e[0]&&(l.appendChild(document.createTextNode(e[0].nodeValue.substring(0,a))),e[0].nodeValue=e[0].nodeValue.substring(a));0<e.length;)i.appendChild(e[0]);d.transferChildNodes(l,t),d.transferChildNodes(i,n)},transferNodeAttributes:function(e,t){for(var n=0;n<e.attributes.length;n++)t.setAttribute(e.attributes[n].name,e.attributes[n].value);return t}};return d});
